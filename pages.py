...
class UrbanRoutesPage:
   ...
   #Pedir lenções e cobertor
    switch_blanket = (By.CSS_SELECTOR, '#root > div > div.workflow > div.workflow-subcontainer > div.tariff-picker.shown > div.form > div.reqs.open > div.reqs-body > div:nth-child(1) > div > div.r-sw > div > span')
    switch_blanket_active = (By.CSS_SELECTOR,'.switch-input:checked+.slider')
